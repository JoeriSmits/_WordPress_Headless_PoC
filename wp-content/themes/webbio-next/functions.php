...
function theme_admin_styles() { 
  wp_enqueue_style('variables', get_theme_file_uri('/css/variables.css'));
  wp_enqueue_style('admin', get_theme_file_uri('/css/admin.css'));
}

add_action('acf/input/admin_enqueue_scripts', 'my_acf_admin_enqueue_scripts');
function my_acf_admin_enqueue_scripts() {
    wp_enqueue_style('acf', get_theme_file_uri('/css/acf.css') );
}
